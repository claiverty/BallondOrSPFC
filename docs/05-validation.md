...
- Universo elegível é informado pela organização. Taxa de participação fica indisponível se denominador não for conhecido; não listar dezenas de milhares de membros para estimá-lo. Analytics incluem agregados por candidato/categoria e linha temporal; detecção sofisticada de fraude/anomalias e gráficos históricos adicionais dependem de dados reais e requisitos específicos.
